...
def detect_lanes_img(img):
    ...
    # Set ROI
    vertices = np.array([[(50,height),(width/2-45, height/2), (width/2+45, height/2), (width-50,height)]], dtype=np.int32)
    ...
    vertices2 = np.array([[(50,height),(width/2-45, height/2), (width/2+45, height/2), (width-50,height)]], dtype=np.int32)
