...
while(1):
    ...
    if circles is not None:
        ...
        for i in circles[0, :]:
            ...
            #cv2.circle(img2, (i[0]+i[2], i[1]+i[2]), i[2], (255, 255, 0), 3)
            #cv2.circle(img2, (i[0]-i[2], i[1]-i[2]), i[2], (255, 255, 0), 3)
            cv2.imshow('Circle', img2)
            print(i[0])
            print(i[1])
            print(i[2])
            #crop_cimg0 = gray[i[1]-i[2]:i[1]+i[2]+i[2] , i[0]-i[2]:i[0]+i[2]+i[2]] #crop from x, y, w, h
            crop_cimg1 = gray[i[1]-i[2]:i[1]+i[2],i[0]-i[2]:i[0]+i[2]] #crop from x, y, w, h
            #crop_cimg2 = gray[i[1]-i[2]:i[1]+i[2],i[0]-i[2]:i[0]+i[2]] #crop from x, y, w, h
            #crop_cimg3 = gray[i[1]-i[2]:300,i[0]-i[2]:320] #crop from x, y, w, h
            #crop_cimg4 = gray[i[1]-i[2]:300,i[0]-i[2]:320] #crop from x, y, w, h 
